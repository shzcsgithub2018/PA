...
opcode_entry opcode_table [512] = {
  ...
  /* 0x68 */	IDEX(I,push), IDEX(I_E2G,imul3), IDEXW(I,push,1), IDEX(imul_1I_E2G,imul3),
  /* 0x6c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x70 */	IDEXW(rel,jcc,1), IDEXW(rel,jcc,1), IDEXW(rel,jcc,1), IDEXW(rel,jcc,1),
  ...
  /* 0x80 */	IDEX(rel,jcc), IDEX(rel,jcc), IDEX(rel,jcc), IDEX(rel,jcc),
