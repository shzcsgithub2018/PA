...
opcode_entry opcode_table [512] = {
  ...
  /* 0x74 */	IDEXW(rel,jcc,1), IDEXW(rel,jcc,1), IDEXW(rel,jcc,1), IDEXW(rel,jcc,1),
  /* 0x78 */	IDEXW(rel,jcc,1), IDEXW(rel,jcc,1), IDEXW(rel,jcc,1), IDEXW(rel,jcc,1),
  /* 0x7c */	IDEXW(rel,jcc,1), IDEXW(rel,jcc,1), IDEXW(rel,jcc,1), IDEXW(rel,jcc,1),
  ...
  /* 0xa8 */	IDEXW(test_I2a,test,1), IDEX(test_I2a,test), EMPTY, EMPTY,
  ...
  /* 0xe8 */	IDEX(rel,call), IDEX(rel,jmp), EMPTY, IDEXW(rel,jmp,1),
  ...
  /* 0x80 */	EMPTY, EMPTY, EMPTY, IDEX(rel,jcc),
