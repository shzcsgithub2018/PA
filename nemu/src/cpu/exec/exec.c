...
opcode_entry opcode_table [512] = {
  /* 0x00 */	EMPTY, EMPTY, EMPTY, IDEX(add_E2G,add),
  /* 0x04 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x08 */	EMPTY, IDEX(G2E,or), EMPTY, EMPTY,
  /* 0x0c */	EMPTY, EMPTY, EMPTY, EX(2byte_esc),
  /* 0x10 */	EMPTY, EMPTY, EMPTY, IDEX(adc_E2G,adc),
  ...
  /* 0x30 */	EMPTY, IDEX(xor_E2G, xor), EMPTY, IDEX(xor_E2G, xor),
  ...
  /* 0x5c */	EMPTY, IDEX(pop_r32,pop), EMPTY, EMPTY,
  /* 0x60 */	EMPTY, EMPTY, IDEXW(I,push,1), EMPTY,
  /* 0x64 */	EMPTY, EMPTY, EX(operand_size), EMPTY,
  /* 0x68 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x6c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x70 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x74 */	IDEXW(rel,jcc,1), EMPTY, EMPTY, EMPTY,
  ...
  /* 0xe8 */	IDEX(rel,call), EMPTY, EMPTY, EMPTY,
  ...
  /* 0x94 */	IDEX(setcc_E,setcc), EMPTY, IDEX(setcc_E,setcc), EMPTY,
